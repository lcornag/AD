...
namespace PCategoria
{
	public partial class Window
	{
		...
		protected virtual void Build ()
		{
			...
			this.Name = "PCategoria.Window";
			this.Title = global::Mono.Unix.Catalog.GetString ("Window");
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			// Container child PCategoria.Window.Gtk.Container+ContainerChild
			this.vbox1 = new global::Gtk.VBox ();
			this.vbox1.Name = "vbox1";
			this.vbox1.Spacing = 6;
			// Container child vbox1.Gtk.Box+BoxChild
			this.UIManager.AddUiFromString ("<ui><toolbar name='toolbar1'><toolitem name='refreshAction1' action='refreshAction1'/><toolitem name='saveAction' action='saveAction'/></toolbar></ui>");
